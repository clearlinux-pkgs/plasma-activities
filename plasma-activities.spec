...
Version  : 6.0.0
Release  : 1
URL      : https://download.kde.org/stable/plasma/6.0.0/plasma-activities-6.0.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.0/plasma-activities-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.0/plasma-activities-6.0.0.tar.xz.sig
...
%prep
%setup -q -n plasma-activities-6.0.0
cd %{_builddir}/plasma-activities-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709392211
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasmaActivities.so.6.0.0
