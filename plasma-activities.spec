...
Version  : 6.3.3
Release  : 26
URL      : https://download.kde.org/stable/plasma/6.3.3/plasma-activities-6.3.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.3/plasma-activities-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/plasma-activities-6.3.3.tar.xz.sig
...
%setup -q -n plasma-activities-6.3.3
cd %{_builddir}/plasma-activities-6.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742500719
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasmaActivities.so.6.3.3
