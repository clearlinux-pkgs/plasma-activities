...
Version  : 6.1.2
Release  : 13
URL      : https://download.kde.org/stable/plasma/6.1.2/plasma-activities-6.1.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.2/plasma-activities-6.1.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.2/plasma-activities-6.1.2.tar.xz.sig
...
%setup -q -n plasma-activities-6.1.2
cd %{_builddir}/plasma-activities-6.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720601710
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasmaActivities.so.6.1.2
