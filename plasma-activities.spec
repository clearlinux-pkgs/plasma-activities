...
Source0  : https://download.kde.org/stable/plasma/6.3.4/plasma-activities-6.3.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.4/plasma-activities-6.3.4.tar.xz.sig
...
%setup -q -n plasma-activities-6.3.4
cd %{_builddir}/plasma-activities-6.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744132860
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasmaActivities.so.6.3.4
