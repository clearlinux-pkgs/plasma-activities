...
Source0  : https://download.kde.org/stable/plasma/6.1.1/plasma-activities-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/plasma-activities-6.1.1.tar.xz.sig
...
%setup -q -n plasma-activities-6.1.1
cd %{_builddir}/plasma-activities-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719423608
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasmaActivities.so.6.1.1
