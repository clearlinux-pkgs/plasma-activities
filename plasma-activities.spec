...
Version  : 6.0.4
Release  : 9
URL      : https://download.kde.org/stable/plasma/6.0.4/plasma-activities-6.0.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.4/plasma-activities-6.0.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.4/plasma-activities-6.0.4.tar.xz.sig
...
%setup -q -n plasma-activities-6.0.4
cd %{_builddir}/plasma-activities-6.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713318365
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasmaActivities.so.6.0.4
